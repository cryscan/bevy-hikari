...
use bevy_hikari::{volume::Volume, GiPlugin, NotGiReceiver};
...
fn light_rotate_system(
    ...
    mut queries: ParamSet<(
        Query<&LookTransform, With<Camera>>,
        Query<(&mut LookTransform, &Transform), With<DirectionalLight>>,
        Query<&mut Transform, With<DirectionalLightTarget>>,
    )>,
) {
...
pub fn toggle_enable_volume(keyboard_input: Res<Input<KeyCode>>, mut volume: ResMut<Volume>) {
